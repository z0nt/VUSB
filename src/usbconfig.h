...
/* This allows to configure the library from the sketch.  Add the following line
 * to platform.local.txt file:
 *   build.extra_flags=-I{build.source.path}
 * Then create vusbconfig.h in the sketch folder and use it for any overrides
 * below.
 */
 ...
 */
#ifndef USB_CFG_SUPPRESS_INTR_CODE
 ...
 */
#ifndef USB_CFG_HAVE_FLOWCONTROL
 ...
 */
#ifndef USB_CFG_CHECK_DATA_TOGGLING
 ...
 */
#if !defined(USB_CFG_VENDOR_NAME) && !defined(USB_CFG_VENDOR_NAME_LEN)
 ...
 * details.
 */
#if !defined(USB_CFG_DEVICE_NAME) && !defined(USB_CFG_DEVICE_NAME_LEN)
...
#endif
#ifndef USB_CFG_DEVICE_SUBCLASS
